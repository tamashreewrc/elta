...
@section('content')
    ...
    <section class="content">
      <div class="box box-default">
        ...
        <form role="form" method="post" action="{{ url('/') }}/banner/edit/{{$banner->id}}" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="box-body">
                 <div class="row">   
                  <div class="col-md-6">
                    <div class="form-group has-feedback {{ $errors->has('editBannerTitle') ? 'has-error' : '' }}">   
                      ...
                      <div class="form-group has-feedback {{ $errors->has('editBannerImage') ? 'has-error' : '' }}">
                        ...
                        <br><img src="{{ url('/') }}/upload/banners/resize/{{$banner->banner_image}}" style="width: 75px;height: 75px;" class="img-thumbnail"><br><br>
