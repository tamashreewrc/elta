    ...
    <!-- <a href="javascript:void(0)"><button type="button" id="add_teacher" class="btn btn-success m-r-5 m-b-5">Add Teachers</button></a> -->
      <!-- </small> -->
       ...
       <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('/') }}/admin/teachers">Teachers</a></li>
       </ol>
  </section>
          ...
          <thead>
            ...
            <tr class="odd gradeX">
                ...
                <td>
                    ...
                    <a title="Delete" href="{{ url('/') }}/admin/teacher/delete/{{$value['id']}}" onclick="return confirm('Do you really want to delete the current record ?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
            </tbody>
