...
@section('content')
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <form method="POST" action="/team_members/edit_submit/{{ $team_member_details['id'] }}" name="team_member_edit_form" id="team_member_add_form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="col-md-6">
