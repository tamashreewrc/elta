         ...
         <section class="content-header">
           ...
           <h1>
             ...
             <ol class="breadcrumb">
              ...
              <li class="active"><a href="{{ url('/') }}/admin/cms/contact_us">Contact Us</a></li> 
          ...
          <section class="content">
           ...
           <div class="box box-default">
            ...
            <form method="POST" action="{{ url('/') }}/admin/contact_submit" name="contact_us_form" id="contact_us_form" enctype="multipart/form-data">
