         ...
         <section class="content-header">
           ...
           <h1>
             ...
             <ol class="breadcrumb">
              ...
              <li class="active"><a href="{{ url('/') }}/admin/cms/home">ELTA</a></li>
          ...
          <section class="content">
           ...
           <div class="box box-default">
            ...
            <form method="POST" action="{{ url('/') }}/admin/home_content_submit" name="home_content_form" id="home_content_form" enctype="multipart/form-data">
