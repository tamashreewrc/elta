         ...
         <section class="content-header">
           ...
           <h1>
             ...
             <ol class="breadcrumb">
              ...
              <li class="active"><a href="{{ url('/') }}/admin/cms/about_us">About Us</a></li> 
          ...
          <section class="content">
           ...
           <div class="box box-default">
            ...
            <form method="POST" action="{{ url('/') }}/admin/about_submit" name="about_us_form" id="about_us_form" enctype="multipart/form-data">
