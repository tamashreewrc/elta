...
<section class="content">
     <div class="box box-default">
       ...
       <form method="POST" action="/admin/event_update/{{$event_details['id']}}" name="event_edit_form" id="event_edit_form" enctype="multipart/form-data"> 
            {{ csrf_field() }}
           <div class="box-body">
           <div class="row">      
            <div class="col-md-6">         
         ...
         <table id="example1" class="table table-bordered table-striped">
          <thead>
            ...
            <tbody>
              ...
              <td> <a title="Delete" href="/admin/event_content/delete/{{$value['id']}}" onclick="return confirm('Do you really want to delete the current record ?');" class="btn-sm btn-danger"><i class="fa fa-trash"></i></a>
              </td>         
             </tr>
              @endforeach
               </tbody>
