   ...
   <div class="col-xs-12">
    ...
    <div class="box">
      ...
      <div class="box-header clearfix">
         ...
         <a title="Add Download" href="{{ url('/') }}/admin/download/add" class="btn btn-success add_all_pages pull-right"><i class="fa fa-plus"></i></a>
         ...
         <table id="example1" class="table table-bordered table-striped">
          ...
          <thead>
            ...
            <tbody>
              ...
              <td colspan="2"><a title="Edit" href="{{ url('/') }}/admin/download/edit/{{$value['id']}}" class="btn-sm btn-primary"><i class="fa fa-pencil"></i></a>

               <a title="Delete" href="{{ url('/') }}/admin/download/delete/{{$value['id']}}" onclick="return confirm('Do you really want to delete the current record ?');" class="btn-sm btn-danger"><i class="fa fa-trash"></i></a>
