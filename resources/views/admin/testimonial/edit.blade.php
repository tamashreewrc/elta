...
<section class="content">
       ...
       <form method="POST" action="{{ url('/') }}/admin/testimonial_edit/{{$testimonial_details['id']}}" name="testimonial_edit_form" id="testimonial_edit_form" enctype="multipart/form-data">
