...
@section('content')
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <form method="POST" action="/service_category/edit_submit/{{ $service_category_details['id'] }}" name="service_category_edit_form" id="service_category_edit_form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="col-md-4">
