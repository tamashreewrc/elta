        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header clearfix">
              ...
              <a title="Add Service Category" href="{{ url('/') }}/admin/service_categories/add" class="btn btn-success add_all_pages pull-right"><i class="fa fa-plus"></i></a>
              ...
              <table id="service_category_listings" class="table table-bordered table-striped service_category_listings">
                ...
                @foreach($service_categories as $key => $value)
                  ...
                  <tr>
                    ...
                    <a title="Edit" href="{{ url('/') }}/admin/service_categories/edit/{{$value['id']}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>

                    <a title="Delete" href="{{ url('/') }}/service_category/delete/{{$value['id']}}" onclick="return confirm('Do you really want to delete the current record ?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
